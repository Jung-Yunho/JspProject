...
public class Calc2 extends HttpServlet{
	...
	@Override
	//protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {			//service 대신에 doGet을 써도 됨 or doPost
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		int sum = x + y;
			...
			out.write("				<input type = \"submit\" id = \"btn-Application\" value = \"Application\"/>");
			out.write("				<input type = \"submit\" id = \"btn-Session\" value = \"Session\"/>");
			out.write("				<input type = \"submit\" id = \"btn-Cookie\" value = \"Cookie\"/>");
			out.write("			</div>");
